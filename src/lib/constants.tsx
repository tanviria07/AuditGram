...
export const GITHUB_REPO_URL = 'https://github.com/yourusername/auditgram';
...
export const STEPS_BY_PLATFORM: Record<string, StepInfo[]> = {
  ...
  web: [
    ...
    { title: 'Choose JSON and download ZIP', description: 'Select JSON (not HTML), submit the request, and download the ZIP file when it’s ready.', helperText: 'Instagram may prepare your file in the background and send you an email when it’s ready.', icon: <CheckCircle2 className="w-16 h-16 text-emerald-500" /> },
  ],
};
